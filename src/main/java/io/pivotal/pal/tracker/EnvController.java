...
public class EnvController {
    ...
    public Map<String, String> getEnv() {
        ...
        someMap.put("PORT", port);
        someMap.put("MEMORY_LIMIT", memory_limit);
        someMap.put("CF_INSTANCE_INDEX", cf_instance_index);
        someMap.put("CF_INSTANCE_ADDR", cf_instance_addr);
        return someMap;
    }
}
