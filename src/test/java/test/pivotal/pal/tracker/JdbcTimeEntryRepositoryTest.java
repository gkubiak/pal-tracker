...
public class JdbcTimeEntryRepositoryTest {
    ...
    public void createInsertsATimeEntryRecord() throws Exception {
        TimeEntry newTimeEntry = new TimeEntry(321, 123, LocalDate.parse("2017-01-09"), 8);
    ...
    public void updateReturnsTheUpdatedRecord() throws Exception {
        ...
        TimeEntry timeEntryUpdates = new TimeEntry(987, 456, LocalDate.parse("2017-01-10"), 10);
    ...
    public void updateUpdatesTheRecord() throws Exception {
        ...
        TimeEntry updatedTimeEntry = new TimeEntry(322, 456, LocalDate.parse("2017-01-10"), 10);
